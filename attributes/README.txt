...
| | | | |
|Consonant heaviness index, |CHeavyObstr |Sum of OnsCoda plus Obstr/3  |1.33* - 41.66* |
| | | | |
|Obstruents only | | | |
| | | | |
...
| | | | |
|Vowel length pattern |VLength |Vowel length contrast affecting basic vowel qualities |None, Some, All, Other (more long thsn short vowels) |
| | | | |
